...
func (c *ReviewClient) QueryReviewer(r *Review) *UserQuery {
...
// QueryReviwedTool queries the reviwedTool edge of a Review.
func (c *ReviewClient) QueryReviwedTool(r *Review) *ToolQuery {
